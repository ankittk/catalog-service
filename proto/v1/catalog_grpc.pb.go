...
const (
	CatalogService_ListServices_FullMethodName       = "/v1.CatalogService/ListServices"
	CatalogService_GetService_FullMethodName         = "/v1.CatalogService/GetService"
	CatalogService_GetServiceVersions_FullMethodName = "/v1.CatalogService/GetServiceVersions"
)
...
func (c *catalogServiceClient) GetServiceVersions(ctx context.Context, in *GetServiceVersionsRequest, opts ...grpc.CallOption) (*GetServiceVersionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CatalogService_GetServiceVersions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CatalogService_GetServiceVersions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_GetServiceVersions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
